...
<div class="d-grid gap-2 col-6 mx-auto mt-5">
  <button type="button" class="btn btn-outline-info"><a href="createregistry.php"><h3>Create Registry</h3></a></button>
</div>
<div class="d-grid gap-2 col-6 mx-auto mt-3">
  <button type="button" class="btn btn-outline-info"><a href="sendRegistry.php"><h3>Send Registry</h3></a></button>
</div>
<div class="d-grid gap-2 col-6 mx-auto mt-3">
